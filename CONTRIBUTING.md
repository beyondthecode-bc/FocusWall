# Contributing to FocusWall

## Translations

FocusWall ships with 8 languages: English (source), French, German, Spanish, Japanese, Korean, Portuguese (Brazilian), and Chinese (Simplified). Native-speaker refinements via PR are welcome.
...
- **Technical terms** stay in English in all locales (e.g., Pomodoro, Bundle ID, GitHub)
- **App name** "FocusWall" is never translated
